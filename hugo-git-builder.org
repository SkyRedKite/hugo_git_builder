...
commentary or improve how it works (and capture that).  I'm also
prepare to post this publicly as possible a useful tool for other Hugo
users.  It may be useful talk about how I am transforming the program
through multiple post?
